...
def test_classification_flags_change_with_asymmetry():
    ...
    thresholds = RegimeThresholds(
        D_geo_small=0.05, D_geo_large=0.2, S_lat_scoliotic=0.02, cobb_scoliotic_deg=3.0
    )
    ...
    # Asymmetric / curved metrics: larger scoliosis measures
    z_asym, y_asym = _make_curve(offset=0.05)
    metrics_asym = compute_scoliosis_metrics(z_asym, y_asym, frac=0.2)
