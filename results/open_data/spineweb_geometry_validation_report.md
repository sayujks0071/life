...
- Feature table: `results/open_data/spineweb_landmark_features.csv`
- Validation summary: `results/open_data/spineweb_geometry_validation_summary.json`
- Manual-review outliers: `results/open_data/spineweb_geometry_validation_outliers.csv`
- Figure panels: `results/open_data/spineweb_geometry_validation_panels.png`
