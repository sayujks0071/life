Starting Bolt-BioFold Analysis Cycle on 13 proteins...
...
Processing PPARGC1A (Q9UBK2)...
Querying API for Q9UBK2...
Downloading PDB from https://alphafold.ebi.ac.uk/files/AF-Q9UBK2-F1-model_v6.pdb...
Downloading PAE from https://alphafold.ebi.ac.uk/files/AF-Q9UBK2-F1-predicted_aligned_error_v6.json...
Processing GHR (P10912)...
Querying API for P10912...
Downloading PDB from https://alphafold.ebi.ac.uk/files/AF-P10912-F1-model_v6.pdb...
Downloading PAE from https://alphafold.ebi.ac.uk/files/AF-P10912-F1-predicted_aligned_error_v6.json...
Processing ARNTL (O00327)...
Querying API for O00327...
Downloading PDB from https://alphafold.ebi.ac.uk/files/AF-O00327-F1-model_v6.pdb...
Downloading PAE from https://alphafold.ebi.ac.uk/files/AF-O00327-F1-predicted_aligned_error_v6.json...
Processing MYLK (Q15746)...
Querying API for Q15746...
Downloading PDB from https://alphafold.ebi.ac.uk/files/AF-Q15746-F1-model_v6.pdb...
Downloading PAE from https://alphafold.ebi.ac.uk/files/AF-Q15746-F1-predicted_aligned_error_v6.json...
...
- **PPARGC1A**: (Low Confidence). We see: Intermediate shape, High local curvature. Matters: Structural metrics imply role in mechanical integrity or sensing. Next: Analyze IDR phase separation potential.
- **GHR**: (Low Confidence). We see: Highly elongated/Fibrous, 54 potential hinge(s), High local curvature. Matters: Structural metrics imply role in mechanical integrity or sensing. Next: Test mechanical gating/unfolding under force.
- **ARNTL**: (Low Confidence). We see: Highly elongated/Fibrous, 6 potential hinge(s), High local curvature. Matters: Structural metrics imply role in mechanical integrity or sensing. Next: Test mechanical gating/unfolding under force.
- **MYLK**: (Low Confidence). We see: Globular, 31 potential hinge(s), High local curvature. Matters: Structural metrics imply role in mechanical integrity or sensing. Next: Analyze IDR phase separation potential.
