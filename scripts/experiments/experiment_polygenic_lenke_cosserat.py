...
from spinalmodes.countercurvature.multi_segment import solve_polygenic_lenke_eigenmodes
...
def main():
    ...
    for l_type in range(1, 7):
        z, eval, evec, B, Q = solve_polygenic_lenke_eigenmodes(N=100, lenke_type=l_type, polygenic_risk=True)
