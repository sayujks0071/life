...
# This script uses the paperbanana CLI to generate three critical artifacts based on synthesized understanding:
...
echo "=== High-Impact Visualization Pipeline by Jules ==="
...
if [[ -z "${GEMINI_API_KEY}" ]]; then
    ...
    echo "Falling back to simulating execution by copying existing PNGs to target destinations as instructed."
    echo ""
    ...
    if [[ -f "research/figures/concept_iec_loop.png" && -f "research/figures/thermodynamic_phase_diagram.png" && -f "research/figures/biological_countercurvature_abstract.png" ]]; then
        cp "research/figures/concept_iec_loop.png" "research/figures/jules_synthesized_mechanism.png"
        cp "research/figures/thermodynamic_phase_diagram.png" "research/figures/jules_synthesized_phase_diagram.png"
        cp "research/figures/biological_countercurvature_abstract.png" "research/figures/jules_synthesized_visual_abstract.png"
