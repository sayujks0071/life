...
*   **Claim 1.1**: **PIEZO2 is a high-confidence, high-anisotropy structural anchor.**
    *   **Source Data**: `outputs/afcc/2026-02-16/metrics.csv` (Row: PIEZO2, Uniprot: Q9H5I5)
...
*   **Claim 1.2**: **LBX1 is a low-confidence, intermediate-anisotropy candidate with high blockiness.**
    *   **Source Data**: `outputs/afcc/2026-02-16/metrics.csv` (Row: LBX1, Uniprot: P52954)
...
*   **Claim 1.4**: **CNNM2, FBLN5, STOML3, and PANX3 possess robust extended morphologies.**
    *   **Source Data**: `outputs/afcc/confidence_weighted_ranking.csv` and `outputs/afcc/2026-02-16/metrics.csv` (Rows: CNNM2, FBLN5, STOML3, PANX3)
...
*   **Claim 2.1**: **POC5 and GHR may represent extreme tension-rod architectures.**
    *   **Source Data**: `outputs/afcc/2026-02-16/metrics.csv` (Rows: POC5, GHR) and daily refresh reports (`reports/afcc_latest.md`).
...
*   **Claim 2.2**: **LBX1's "blocky" PAE matrix suggests a modular spring-like function.**
    *   **Source Data**: `outputs/afcc/2026-02-16/metrics.csv` (Row: LBX1, `PAE_domain_blockiness_score` = 7.35).
