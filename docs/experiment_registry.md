...
| **TOY_06_Tensegrity** | `scripts/experiment_tensegrity_spine.py` | **Toy Model F:** Spinal Tensegrity Model. | `outputs/figures/toy_model_tensegrity.png` | ✅ **Active** | Demonstrates active tension counteracting gravity. |
