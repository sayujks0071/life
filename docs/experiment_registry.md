...
| **EXP_12_StiffnessSweep**| `scripts/experiments/run_stiffness_sweep.py`| Tests stiffness modulation ($\chi_E$) effect on sag. | `outputs/sim/*/results.csv` | ✅ **Active** | Added to tracking. |
