...
| **EXP_06_CrossSpecies** | `scripts/experiment_cross_species_scaling.py` | Generate Figure 3: Validates cross-species scaling mapping. Maps $L$, $R$, $EI$, mass for 10 species. | `outputs/thermodynamic_cost/cross_species_scaling.csv` | ✅ **Active** | Added. |
