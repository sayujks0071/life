...
| **EXP_12_SpinalSymphony**| `scripts/experiment_spinal_symphony.py`| Generates Acoustic Biomarker ("Scoliosis Scream") diagnostics. Sonifies geometric time-series curvature/torsion anomalies. | `outputs/spinal_symphony/spinal_spectrograms.png` | ✅ **Active** | Out-of-the-box enhancement testing sonification diagnosis. |
