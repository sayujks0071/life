# Research Progress Update: 2026-05-25
...
| **EXP_03** (Exploding Gradient) | ✅ Done | Shows failure when $\chi_\kappa$ is high and noise $\sigma > \sigma_c$. | `scripts/experiment_optimization_failure.py` |
