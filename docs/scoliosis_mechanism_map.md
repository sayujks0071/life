...
### 18. CPG Locomotor Coordination
* **Path**: `EPHA4` $\rightarrow$ `CPG Coordination` $\rightarrow$ `Muscle Tone`
* **Mechanism**: EPHA4 signaling is crucial for the proper development of Central Pattern Generators (CPGs) and locomotor circuits.
* **Role**: **Locomotor Asymmetry**. Counter-curvature requires coordinated, symmetric muscle activation to maintain the anti-gravity S-curve. Disruption of EPHA4 signaling leads to impaired CPGs and abnormal locomotor coordination, resulting in asymmetric muscle tone that directly destabilizes the spine and precipitates scoliotic curvature.
* **Evidence**: Wang et al. (2024, eLife) demonstrated that EPHA4 signaling dysregulation links abnormal locomotion and the development of idiopathic scoliosis.
> **Hypothesis**: The integrity of CPG-driven locomotor circuits serves as a continuous calibration signal for the mechanosensory feedback loop. Loss of this coordination deprives the active control system of symmetric baseline tone, precipitating Euler buckling.
