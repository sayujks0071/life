...
### 18. BMSC Ciliary Mechanosensing Defect
* **Path**: `CILIA` $\rightarrow$ `BMSCs Cilia` $\rightarrow$ `Gain (G_{mech})` & `Osteogenesis`
* **Mechanism**: Primary cilia on bone marrow stem cells (BMSCs) act as critical mechanosensors that mediate intracellular signaling pathways. Defects in cilia genes impair ciliogenesis, cellular signaling, and mechanical sensing, disrupting osteogenic signaling pathways in BMSCs.
* **Role**: **Impaired Osteogenesis and Loss of Adaptive Gain**. The loss of normal ciliary mechanosensory function in BMSCs blunts the adaptive osteogenic response to mechanical loads, leading to defective vertebral alignment and the progression of idiopathic scoliosis.
* **Evidence**: Zhang et al. (2025) demonstrated that primary cilia gene defects in BMSCs disrupt osteogenic signaling pathways and promote idiopathic scoliosis progression in vivo.
> **Hypothesis**: The loss of functional primary cilia in BMSCs uncouples mechanical loading from osteogenesis, creating localized areas of deficient bone matrix that succumb to buckling forces during adolescent growth, thereby collapsing the Counter-Curvature control loop.
