...
### 18. PIEZO1-BMP2 Ossification Brake
* **Path**: `PIEZO1` $\rightarrow$ `BMP2` $\rightarrow$ `Osteogenesis`
* **Mechanism**: In the annulus fibrosus, mechanical stress activates PIEZO1, which suppresses BMP2-induced osteogenesis (and p-Smad1/5/9 nuclear translocation) via calcineurin signaling.
* **Role**: **Ossification Brake**. By preventing anomalous calcification and ossification of disc tissues under strain, PIEZO1 maintains flexibility. Loss of this mechanosensitive brake leads to premature stiffness and degeneration, impeding the adaptive counter-curvature response required to balance gravitational loads.
* **Evidence**: Shitozawa et al. (2026) demonstrated that PIEZO1 activation maintains annulus fibrosus cell homeostasis by suppressing osteogenic changes under mechanical stress.
