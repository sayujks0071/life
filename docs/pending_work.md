...
| **CLIN-02** | **Curve Type Prediction** | Refine `experiment_lenke_classes.py` to robustly predict Lenke 1-6 classifications from spatial deficits. | 2 days | Toy Model D | 🟡 **In Progress** |
