...
**Latest Progress Update:** [docs/progress_update_2026-03-25.md](progress_update_2026-03-25.md)
...
- **Day 3-4:** (Completed) Refined `experiment_lenke_classes.py` to produce a finalized figure mapping spatial deficits to Lenke Classifications.
- **Day 5-6:** (Completed) Mapped sexual dimorphism metrics to model parameters based on literature review (`experiment_sexual_dimorphism.py`).
