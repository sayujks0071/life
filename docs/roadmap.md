...
**Timeline Estimate:** 3-4 Weeks (April 11 - May 10, 2026)
...
## Summary of Risks
1.  **Clinical Data Mismatch:** Abstract physics parameters may not map linearly to clinical metrics.
2.  **IMRaD Reformatting Burden:** Dense theory needs to be simplified into standard sections.
