...
* **Phase 1, Day 2 (Literature Review — AIS genetics)** [2024-05-15]: Completed. Conducted a comprehensive review of major AIS GWAS hits (LBX1, GPR126/ADGRG6, PAX1, BNC2). Documented risk alleles, effect sizes, population frequencies, and proposed biological functions based on primary literature (Takahashi 2011, Kou 2013, Sharma 2015, Ogura 2015). Mapped each gene to a specific $\tau$ component or to the plant geometry. Output generated in `paper4_literature/day2_ais_gwas.md`.
...
* GWAS hits partition into two groups: those affecting the neural controller $\tau$ (e.g., LBX1 for $\tau_{spin}$, GPR126 for $\tau_{aff}$) and those affecting the mechanical "plant" (e.g., PAX1, BNC2 for vertebral bone/cartilage).
* GPR126 is confirmed as the strongest candidate for driving $\tau_{aff}$ (afferent conduction delay) due to its essential role in Schwann cell myelination.
...
## Next Session
* **Phase 1, Day 3**: Literature Review — GPR126 deep dive. Investigate role in Schwann cell myelination, peripheral nerve development, knockout phenotypes, and nerve conduction velocity data. Search for AlphaFold structure and AIS variant mapping. Output to `paper4_literature/day3_gpr126.md`.
