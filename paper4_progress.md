...
* **Phase 1, Day 2 (Literature Review — AIS genetics)**: Completed. Comprehensive review of GWAS hits (GPR126, LBX1, PAX1). Detailed risk alleles, effect sizes, and proposed biological functions. Outputs stored in `paper4_literature/day2_ais_gwas.md`.
...
* Genetic architecture of AIS implicates multiple pathways: GPR126 and LBX1 alter the neural transmission controller (increasing $\tau$), whereas PAX1 appears to alter the mechanical "plant" (vertebral geometry).
...
* For PAX1, how should structural geometric effects be modeled vs. delay controller effects?
