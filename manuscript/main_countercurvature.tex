...
% - Present spine S-curve and plant experiments.
% - Highlight difference between passive and info-driven solutions.
% - Introduce D_geohat as quantitative measure.

% TODO: Paste from docs/paper_draft_results_subsection.md
% Expand with:
% - Spine S-curve: χ_κ sweep results
...
% - Describe (χ_κ, g) plane.
% - Define gravity-dominated, cooperative, information-dominated regimes.
% - Refer to phase diagram figure.

% TODO: Expand with:
% - Contour plot description
% - Three regime boundaries (D_geohat thresholds)
