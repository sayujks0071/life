...
\textbf{Living systems must actively maintain structural integrity against gravity. We show that Adolescent Idiopathic Scoliosis (AIS) is a predictable "Metabolic Buckling" event caused by a mismatch between mechanical demand and metabolic supply. Modeling the spine as a dissipative structure, we identify a critical "Energy Deficit Window" ($L > 0.35$m) where the strain energy cost of alignment ($L^3$) exceeds surface-limited metabolic capacity ($L^2$). We find that key mechanosensors like Vimentin are thermodynamically expensive (high anisotropy), creating an unaffordable "Anisotropy Tax" during rapid growth. Simulations demonstrate that this deficit triggers a supercritical bifurcation into a helical deformity. Crucially, reducing sensor anisotropy delays buckling by 60 cm. These results redefine scoliosis as a survival response to metabolic insolvency, suggesting that targeting cytoskeletal stiffness—rather than just mechanical bracing—offers a root-cause therapy.}
