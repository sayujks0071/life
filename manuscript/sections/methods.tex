...
\begin{enumerate}
    \item \textbf{Structure Prediction:} We retrieved predicted structures for 23 key spinal proteins from the AlphaFold Protein Structure Database. A sensitivity analysis was performed by stratifying proteins into high-confidence ($\text{pLDDT} \geq 70$) and low-confidence subsets to ensure robust estimation of structural anisotropy and disorder metrics without bias from intrinsically disordered regions.
