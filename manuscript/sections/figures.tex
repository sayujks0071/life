...
\begin{figure}[h!]
    ...
    \caption{\textbf{The Energy Deficit Window as a Driver of `Spinal Jetlag'.} Thermodynamic cost of countercurvature ($P_{\mathrm{counter}}$, red solid) versus proprioceptive supply capacity ($S_{\mathrm{proprio}}$, blue/green dashed) as a function of spinal length $L$. The intersection at $L_{\mathrm{crit}} \approx 0.35$ m defines a developmental window ($L < L_{\mathrm{crit}}$) where metabolic demand exceeds the transport capacity of the avascular IVD. This deficit creates a \textbf{Convective Shutdown} zone~\cite{sato2025convective}, where the loss of daily load-driven pumping causes local accumulation of lactate. This metabolic stress decouples the peripheral spinal clock from the central rhythm (`Spinal Jetlag'), forcing the system into a high-gain state that amplifies scalar noise (e.g., Piezo1) into scoliotic buckling.}
