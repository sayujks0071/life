...
\begin{figure}[h!]
    ...
    \caption{\textbf{Lenke Classifications as Coupled Cosserat Rod Eigenmodes.} The framework predicts distinct Lenke curve patterns based on the spatial localization of the energy deficit window. Shaded regions indicate localized metabolic energy deficits (increased neural delay or reduced damping). The resulting curves emerge as the dominant eigenmodes of the multi-segment system. (A) Type 1: Main Thoracic. (B) Type 2: Double Thoracic. (C) Type 3: Double Major. (D) Type 4: Triple Major. (E) Type 5: Thoracolumbar/Lumbar. (F) Type 6: TL/L - Main Thoracic.}
