...
\begin{figure}[h!]
    ...
    (B) The countercurvature metric $g_{\mathrm{eff}}(s)$ highlights regions where the Bio-Gravitational Number ($\mathcal{B}_g$) is maximized. This active restoring moment is biologically implemented via the "Urotensin Relay," where CSF flow regulates paraspinal muscle tone.
    ...
    (D) Microgravity adaptation ($g \to 0$). The system relaxes towards the information reference state. The reduced mechanical strain $\gEff$ corresponds to the unloading predicted to downregulate the "Cilio-Nuclear Strain Gauge" (POC5/Lamin A), triggering the adipogenic switch in paraspinal muscles.}
