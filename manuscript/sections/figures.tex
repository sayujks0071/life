...
\begin{figure}[h!]
    ...
    \caption{\textbf{The Energy Deficit Window.} Metabolic power $P_{\mathrm{counter}}$ (red) required to maintain counter-curvature against gravitational sag scales strictly as $L^2$, while proprioceptive supply capacity (blue) scales as $L^{0.5}$. Their intersection at $L_{\mathrm{crit}} \approx 0.35$\,m marks the opening of the Energy Deficit Window. At $L = 0.45$\,m (adolescent spine), the energetic deficit reaches ${\sim}41\%$.}
