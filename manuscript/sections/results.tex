...
Cross-Species Allometric & Exponent = -0.282 $\pm$ 0.072 & Log-log regression & $1.31\times10^{-3}$ & STRONG. $R^2 = 0.744$, 95\% CI: [-0.405, -0.170] \\ \hline
Anisotropy Rescue Effect & $R^2 = 0.775$ & Linear regression & $3.58\times10^{-17}$ & STRONG. Saturation at $\ge 6.0$ \\ \hline
Energy Deficit vs Cobb Angle & $r = 0.983$ & Pearson correlation & $2.74\times10^{-22}$ & STRONG. Deficit Ratio Max = $38.5$ \\ \hline
Circadian Disruption & 2.52-fold increase & Mann-Whitney U & $2.59\times10^{-4}$ & MODERATE. \\ \hline
Vector Mismatch Localization & 31.1\% stiffness reduction & Spatial analysis & N/A & STRONG. Position = $0.596$ (Normalized) \\ \hline
\end{tabular}
...
Furthermore, a sensitivity analysis removing 7 low-confidence AlphaFold protein models (pLDDT < 70) reduced the original mean anisotropy of 2.74 to 2.62. This demonstrates robustness, confirming that structural predictions hold even when strictly relying on high-confidence coordinates. We explicitly acknowledge that these 7 low-confidence proteins include key narrative targets such as POC5, GHR, and MESP2. High anisotropy values derived from intrinsically disordered regions (IDRs) carry inherent uncertainty since the AlphaFold structure may not fully represent the functional conformation. However, the significantly higher disorder fraction observed among the metabolic supply ($\Gamma_m$) proteins aligns with their known biological roles as dynamic molecular switches and signaling hubs, rather than stable structural elements.
