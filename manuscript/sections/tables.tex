...
% Data source: outputs/thermodynamic_cost/thermodynamic_cost_proteins.csv
\begin{table}[h!]
\centering
\caption{Table of key thermodynamic cost proteins grouped by dissipation term ($\eta_p, \eta_a, \Gamma_m$) and characterized by AlphaFold structural metrics. The anisotropy ratio and morphology indicate the structural cost of maintaining orientation (vector sensing) vs. volume (scalar maintenance). The free energy dissipation functional is defined in Eq.~\ref{eq:dissipation}.}
\label{tab:thermodynamic_cost_proteins}
\scriptsize
\begin{tabular}{llcclllc}
\toprule
% Verified data source: outputs/thermodynamic_cost/thermodynamic_cost_proteins.csv
...
ADGRG6 & Q7Z2K8 & $\eta_{a}$ & 3.85 & Fibrous/Extended & 70.0 & 1120 & $L^2$ \\
\midrule
...
TBX6 & O95935 & $\Gamma_{m}$ & 1.95 & Intermediate & 65.0 & 436 & $L$ \\
\bottomrule
\end{tabular}
\end{table}
