...
\begin{table}[h!]
\centering
\caption{Validation of IEC framework predictions against normative clinical datasets. The model's equilibrium state spontaneously generates an S-shaped profile matching observed human sagittal alignment, without prescribing these angles as fixed boundary conditions.}
\label{tab:clinical_comparison}
\small
\begin{tabular}{lccc}
\toprule
\textbf{Parameter} & \textbf{IEC Model ($\chi_\kappa=0.05$)} & \textbf{Vialle et al.\ \cite{vialle2005radiographic}} & \textbf{Bernhardt \& Bridwell \cite{bernhardt1989segmental}} \\
\midrule
Lumbar Lordosis (LL) & $41.2^\circ$ & $41.0^\circ \pm 11.2^\circ$ & $44.0^\circ \pm 11.0^\circ$ \\
Thoracic Kyphosis (TK) & $34.8^\circ$ & $37.0^\circ \pm 9.0^\circ$  & $36.0^\circ \pm 10.0^\circ$ \\
Pelvic Incidence (PI) & $50.1^\circ$ (Derived) & $50.0^\circ \pm 10.0^\circ$ & N/A \\
\bottomrule
\end{tabular}
\end{table}
