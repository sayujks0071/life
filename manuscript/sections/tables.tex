...
\begin{table}[h!]
\centering
\caption{List of thermodynamic cost proteins ($n=16$) grouped by dissipation term ($\eta_p, \eta_a, \Gamma_m$) and characterized by AlphaFold structural metrics. The anisotropy ratio and morphology indicate the structural cost of maintaining orientation (vector sensing) vs. volume (scalar maintenance). The free energy dissipation functional is defined in Eq.~\ref{eq:dissipation}. This table lists the 16 key proteins analyzed in this study.}
...
CDKN1A & P38936 & $\Gamma_{m}$ & 2.14 & Intermediate & 69.0 & 164 & Switch \\
SHH & Q15465 & $\Gamma_{m}$ & 2.12 & Intermediate & 78.4 & 462 & $L$ \\
SIRT1 & Q96EB6 & $\Gamma_{m}$ & 1.73 & Intermediate & 65.0 & 747 & Const. \\
