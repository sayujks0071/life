...
\hypersetup{
    ...
    citecolor=blue,
    urlcolor=blue,
    pdftitle={Biological Countercurvature: An Information--Cosserat Framework for Spinal Geometry},
...
% Title / Authors
% ---------------------------------------------------------------------------
\title{Biological Countercurvature: An Information--Cosserat Framework for Spinal Geometry}
