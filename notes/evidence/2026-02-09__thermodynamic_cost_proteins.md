...
| **DMD** | P11532 | 1.32 | Globular | 22.8 | 76.3 | 525 | 1 | L^3 (muscle volume) | Dystrophin; costamere anchor protecting muscle from contraction damage |
| **MYLK** | Q15746 | 1.46 | Globular | 41.5 | 65.8 | 1914 | 31 | L^2 (cross-sectional tension) | Myosin Light Chain Kinase; regulator of smooth/non-muscle contractility |
...
- **DMD** (L^3 (muscle volume)): Massive rod-like protein (only fragment modeled); essential for force transmission lateral to the muscle fiber axis; loss causes immediate muscle necrosis under load
- **MYLK** (L^2 (cross-sectional tension)): Globular kinase domain; regulates the 'catch bond' property of actin-myosin interaction; essential for maintaining tonic tension with low energy cost
...
| **PPARGC1A** | Q9UBK2 | 2.19 | Intermediate | 31.2 | 52.7 | 798 | 0 | L^3 (mitochondrial density) | PGC-1alpha; master regulator of mitochondrial biogenesis |
| **IGF1R** | P08069 | 1.43 | Globular | 43.2 | 78.0 | 1367 | 35 | dL/dt (growth velocity) | IGF-1 Receptor; sets the metabolic pace of growth |
| **GHR** | P10912 | 5.13 | Fibrous/Extended | 31.4 | 58.7 | 638 | 54 | dL/dt (growth velocity) | Growth Hormone Receptor; systemic regulator of growth velocity |
| **ARNTL** | O00327 | 3.32 | Fibrous/Extended | 32.1 | 65.5 | 626 | 6 | constant (temporal gating) | BMAL1; core circadian clock component |
...
- **PPARGC1A** (L^3 (mitochondrial density)): High disorder (IDR); integrates metabolic signals to drive mitochondrial density; its failure leads to the 'energy crash' in fast-growing muscle
- **IGF1R** (dL/dt (growth velocity)): Large transmembrane receptor; activation scales with systemic growth factor levels; drives the demand side of the equation
- **GHR** (dL/dt (growth velocity)): High anisotropy (fibrous extracellular domain); directly translates pituitary signals into local tissue growth rates
- **ARNTL** (constant (temporal gating)): Transcription factor; temporally gates ECM repair to sleep cycles; misalignment (spinal jetlag) increases metabolic cost of maintenance
