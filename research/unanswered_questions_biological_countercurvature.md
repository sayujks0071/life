...
The 23-protein dataset from `thermodynamic_cost_proteins.csv` provides rigorous quantitative evidence that the biological system managing counter-curvature is systematically biased toward high-cost demand and fragile supply.
...
1.  **PIEZO1:** 9,832 ($3.90 \times 2521$)
2.  **FLNA:** 6,618 ($2.50 \times 2647$)
3.  **COL1A1:** 4,099 ($2.80 \times 1464$)
4.  **VIM:** 3,481 ($7.47 \times 466$)
...
*   Supply system mean disorder: **42.0%**
*   Demand system mean disorder: **35.0%**
